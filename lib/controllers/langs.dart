...
class Lang {
  ...
  Map<String, dynamic> arLangs = {
      ...
      'login_intro_message' : 'تابع ابنائك بكل أمان. \nيرجي تسجيل الدخول إلي حسابك.',
  ...
  Map<String, dynamic> enLangs = {
      ...
      'login_intro_message' : 'Please create your account with your valid information. \nSign in to manage your account.',
  ...
  Map<String, dynamic> esLangs = {
      ...
      'login_intro_message' : 'Inicie sesión para con su usuario y contraseña.',
