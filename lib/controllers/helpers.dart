...
const String googleClientId =
    "815917645468-uclp0ar0v8vu84s81bcqe1fo3oiljioh.apps.googleusercontent.com"; // For Map API

/// Important Note
/// Make sure to add this key at the android/app/src/main/AndroidManifest.xml file
const String googleApiKey =
    "AIzaSyArS67tdH2dJB64hfE0zCh1treUYgHjNm0"; // For Places API
...
class LightTheme implements DefaultTheme {
  ...
  TextStyle h6 = TextStyle(
      ...
      fontFamily: GoogleFonts.cairo().fontFamily);
  @override
  TextStyle xsmallText = TextStyle(
      color: default_color,
      fontSize: 12,
  ...
  TextStyle largeText = TextStyle(
      ...
      fontFamily: GoogleFonts.elMessiri().fontFamily);
  @override
  TextStyle xlargeText = TextStyle(
      color: default_color,
      fontSize: 20,
      fontWeight: FontWeight.w400,
      fontFamily: GoogleFonts.elMessiri().fontFamily);
...
class DarkTheme implements DefaultTheme {
  ...
  @override
  TextStyle h1 = TextStyle(
      color: default_color, fontSize: 36, fontWeight: FontWeight.w600);
  @override
  TextStyle h2 = TextStyle(
      color: default_color, fontSize: 32, fontWeight: FontWeight.w600);
  @override
  TextStyle h3 = TextStyle(
      color: default_color, fontSize: 28, fontWeight: FontWeight.w600);
  @override
  TextStyle h4 = TextStyle(
      color: default_color, fontSize: 24, fontWeight: FontWeight.w600);
  @override
  TextStyle h5 = TextStyle(
      color: default_color, fontSize: 20, fontWeight: FontWeight.w600);
  @override
  TextStyle h6 = TextStyle(
      color: default_color, fontSize: 16, fontWeight: FontWeight.w600);
  @override
  TextStyle xsmallText = TextStyle(color: default_color, fontSize: 12);
  @override
  TextStyle smallText = TextStyle(
      color: default_color, fontSize: 14, fontWeight: FontWeight.w400);
  @override
  TextStyle normalText = TextStyle(
      color: default_color, fontSize: 16, fontWeight: FontWeight.w400);
  @override
  TextStyle largeText = TextStyle(
      color: default_color, fontSize: 18, fontWeight: FontWeight.w400);
  @override
  TextStyle xlargeText = TextStyle(
      color: default_color, fontSize: 20, fontWeight: FontWeight.w400);
}
